class SuppliersController < ApplicationController
  def show
    ...
    @yelling_items = ListItem.find_all_by_job_number_and_partner_id_and_state(params[:format], params[:id], 1)
    ...
    @closed_items = ListItem.find_all_by_job_number_and_partner_id_and_state(params[:format], params[:id], 4)
  end
